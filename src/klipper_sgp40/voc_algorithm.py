...
class VocAlgorithm:
    ...
    def _vocalgorithm_set_states(self, state0, state1):
        self._vocalgorithm__mean_variance_estimator__set_states(
            ...
            state0,
            state1,
            _f16(_VOCALGORITHM_PERSISTENCE_UPTIME_GAMMA),
        )
    ...
    def _vocalgorithm_set_tuning_parameters(
        ...
        self.params.mvoc_index_offset = _fix16_from_int(voc_index_offset)
        self.params.mtau_mean_variance_hours = _fix16_from_int(learning_time_hours)
        self.params.mgating_max_duration_minutes = _fix16_from_int(
            gating_max_duration_minutes
        )
        self.params.msraw_std_initial = _fix16_from_int(std_initial)
        self._vocalgorithm__init_instances()
