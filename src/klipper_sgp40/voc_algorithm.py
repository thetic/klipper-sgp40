...
class VocAlgorithm:
    ...
    def _vocalgorithm_set_tuning_parameters(
        ...
        self.params.mvoc_index_offset = voc_index_offset
        self.params.mtau_mean_variance_hours = learning_time_hours
        self.params.mgating_max_duration_minutes = gating_max_duration_minutes
        self.params.msraw_std_initial = std_initial
        self._vocalgorithm__init_instances()

    def process(self, sraw: int):
        ...
        voc_index = round(self.params.mvoc_index + 0.5)
        return voc_index
